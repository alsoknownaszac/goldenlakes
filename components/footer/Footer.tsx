...
export default function Footer() {
  ...
  return (
    <footer
      id="contacts"
      className={`bg-[url('https://res.cloudinary.com/dsf48vuu9/image/upload/v1658846273/blackbg2_ppaprd.avif')] min-h-[44.4rem] 2xs:min-h-[42.8rem] sm:min-h-[44.6rem] xl:min-h-[46.3rem] bg-fixed bg-center bg-no-repeat bg-cover text-white relative pt-[3rem] 2xs:pt-[3.8rem] sm:pt-[5rem] xl:pt-[6rem] pb-[5rem] 2xs:pb-[5.5rem] sm:pb-[6.4rem] xl:pb-[7.3rem]`}
    >
